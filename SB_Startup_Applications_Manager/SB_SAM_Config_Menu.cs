...
public class LoadStartupConfigForm : Form
{
	...
	private void AddStreamEndingTabControls(TabPage streamEndingTab)
	{
		...
		if (streamEndingTab == null)
			throw new ArgumentNullException(nameof(streamEndingTab));
	...
	private void AddSupportTabControls(TabPage supportTab)
	{
		...
		if (supportTab == null)
			throw new ArgumentNullException(nameof(supportTab));
	...
	private void AddStartupConfigurationControls(TableLayoutPanel mainLayoutPanel)
	{
		...
		startupOptionsPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 70)); // Column 3: Fixed width
		startupOptionsPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100)); // Column 4: Fill remaining space
		startupOptionsPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 140)); // Column 5: Fixed width
		startupOptionsPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 50)); // Column 6: Fixed width
